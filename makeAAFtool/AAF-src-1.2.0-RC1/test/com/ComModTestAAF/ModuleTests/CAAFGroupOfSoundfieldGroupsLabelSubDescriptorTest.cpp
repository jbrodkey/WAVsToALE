...
static const struct CAAFGroupOfSoundfieldGroupsLabelSubDescriptorTestFixture
{
...
static HRESULT Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor_Uninitialized(
    IAAFGroupOfSoundfieldGroupsLabelSubDescriptor* pChannelLabelDesc)
{
    // Nothing to test
    return S_OK;
}
...
static HRESULT Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor_Initialize(
    IAAFGroupOfSoundfieldGroupsLabelSubDescriptor* pChannelLabelDesc)
{
    HRESULT  hr = S_OK;
    ...
    try
    {
        ...
        // Initialize GroupOfSoundfieldGroupsLabelSubDescriptor object
...
static HRESULT Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor(
    IAAFGroupOfSoundfieldGroupsLabelSubDescriptor* pChannelLabelDesc,
    testMode_t mode)
{
    // No methods to test
    ...
    aafProductIdentification_constref productID)
{
    ...
    try
    {
        ...
        // Create a GroupOfSoundfieldGroupsLabelSubDescriptor
        IAAFSmartPointer<IAAFGroupOfSoundfieldGroupsLabelSubDescriptor> pChannelLabelDesc;
        CheckResult(defs.cdGroupOfSoundfieldGroupsLabelSubDescriptor()->CreateInstance(
            IID_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor,
            (IUnknown **)&pChannelLabelDesc));

        // Before initialization test if the SoundDescriptor
        // methods return valid error values.
        CheckResult(Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor_Uninitialized(pChannelLabelDesc));

        // Initialize
        Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor_Initialize(pChannelLabelDesc);
        ...
        // Attach the IAAFGroupOfSoundfieldGroupsLabelSubDescriptor to the SoundDescriptor
        ...
        CheckResult(pMob->SetName(L"GroupOfSoundfieldGroupsLabelSubDescriptorTest"));
        ...
        // Test initialized GroupOfSoundfieldGroupsLabelSubDescriptor.
        CheckResult(Test_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor(pChannelLabelDesc,
    ...
    aafWChar * pFileName)
{
    ...
    try
    {
        ...
        // Get the GroupOfSoundfieldGroupsLabelSubDescriptor
        ...
        IAAFSmartPointer<IAAFGroupOfSoundfieldGroupsLabelSubDescriptor> pChannelLabelDesc;
        CheckResult(pSubDesc->QueryInterface(IID_IAAFGroupOfSoundfieldGroupsLabelSubDescriptor,
...
extern "C" HRESULT CAAFGroupOfSoundfieldGroupsLabelSubDescriptor_test(
    testMode_t mode,
    aafUID_t fileKind,
    testRawStorageType_t rawStorageType,
...
//
HRESULT CAAFGroupOfSoundfieldGroupsLabelSubDescriptor_test(
    testMode_t mode,
    aafUID_t fileKind,
    testRawStorageType_t rawStorageType,
    aafProductIdentification_t productID)
{
    ...
    {
        cerr << "CAAFGroupOfSoundfieldGroupsLabelSubDescriptor_test...Caught general C++"
             << " exception!" << endl; 
