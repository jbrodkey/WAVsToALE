//@doc
//@class    AAFAudioChannelLabelSubDescriptor | Implementation class for AAFAudioChannelLabelSubDescriptor
#ifndef __CAAFAudioChannelLabelSubDescriptor_h__
#define __CAAFAudioChannelLabelSubDescriptor_h__
...
class CAAFAudioChannelLabelSubDescriptor
  : public IAAFAudioChannelLabelSubDescriptor,
...
protected:
  ...
  //
  CAAFAudioChannelLabelSubDescriptor (IUnknown * pControllingUnknown, aafBool doInit = kAAFTrue);
  virtual ~CAAFAudioChannelLabelSubDescriptor ();
...
public:
  ...
  //
  STDMETHOD (SetSoundfieldGroupLinkID) (
  ...
  ///   - pLinkID arg is NULL.
  //
  STDMETHOD (GetSoundfieldGroupLinkID) (
    // Link ID of the channel's Soundfield Group. 
...
#endif // ! __CAAFAudioChannelLabelSubDescriptor_h__
