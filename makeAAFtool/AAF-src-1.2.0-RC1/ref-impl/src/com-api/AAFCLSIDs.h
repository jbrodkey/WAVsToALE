...
EXTERN_C const CLSID CLSID_AAFAsyncStreamRawStorage;
EXTERN_C const CLSID CLSID_AAFAudioChannelLabelSubDescriptor;
EXTERN_C const CLSID CLSID_AAFAuxiliaryDescriptor;
EXTERN_C const CLSID CLSID_AAFAVCSubDescriptor;
...
EXTERN_C const CLSID CLSID_AAFGroupOfSoundfieldGroupsLabelSubDescriptor;
EXTERN_C const CLSID CLSID_AAFHeader;
EXTERN_C const CLSID CLSID_AAFIOCompletion;
...
EXTERN_C const CLSID CLSID_AAFJPEG2000SubDescriptor;
...
EXTERN_C const CLSID CLSID_AAFMCALabelSubDescriptor;
EXTERN_C const CLSID CLSID_AAFMetaDefinition;
EXTERN_C const CLSID CLSID_AAFMob;
EXTERN_C const CLSID CLSID_AAFMobSlot;
EXTERN_C const CLSID CLSID_AAFMPEG4VisualSubDescriptor;
EXTERN_C const CLSID CLSID_AAFMPEGAudioDescriptor;
...
EXTERN_C const CLSID CLSID_AAFSoundfieldGroupLabelSubDescriptor;
...
EXTERN_C const CLSID CLSID_AAFStreamRawStorage;
...
EXTERN_C const CLSID CLSID_AAFTypeDefGenericCharacter;
