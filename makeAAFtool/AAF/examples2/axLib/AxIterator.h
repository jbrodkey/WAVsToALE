// typedef AxIterator< IAAFSmartPointer2<IAAFRecord>, IEnumAAFRecords, AddrOfSmartPointer2<IAAFRecord> > AxRecordIterator;
#ifndef __AxIterator_h__
#define __AxIterator_h__

//=---------------------------------------------------------------------=
//
// $Id: AxIterator.h,v 1.19 2009/06/01 11:46:56 stuart_hc Exp $ $Name: V116 $
//
