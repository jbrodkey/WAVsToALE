...
typedef LPCSTR    LPCOLESTR;
 #define OLESTR(str) str
...
#else
  // C definitions for COM macros and interfaces
  #define STDCALL 
  #define EXPORTDLL
  #define STDMETHODCALLTYPE 
  ...
  #define interface struct
  #define DECLARE_INTERFACE(iface) typedef struct iface iface; struct iface
  #define DECLARE_INTERFACE_(iface, baseiface) typedef struct iface iface; struct iface
  ...
  {
      STDMETHOD(CreateInstance) (THIS_ IUnknown __RPC_FAR *pUnkOuter, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
...
// macOS (Darwin) is a UNIX variant
#define OS_UNIX 1
