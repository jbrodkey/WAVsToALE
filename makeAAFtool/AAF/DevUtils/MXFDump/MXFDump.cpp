//=---------------------------------------------------------------------=
//
// $Id: MXFDump.cpp,v 1.790.4.1 2012/10/09 00:20:02 jptrainor Exp $ $Name: V116 $
//
...
void printPartition(mxfKey& /* k */, mxfLength& len, mxfFile infile)
{
  ...
  fprintf(stdout, "%20s = ", "EssenceContainers"); // No macro concatenation here, so no change needed
  mxfUInt32 elementCount;
